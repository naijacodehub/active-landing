  ...
  return (
    <div className='general-padding py-20'>
          ...
          return (
            <div
              ...
              className={`ml-5 relative ${
                (idx === 5 || idx === 4) && '!border-none'
              } border-l dark:border-pale-sky/50 border-dashed px-16 pb-28`}
            >
              <img
                src='/Images/normalOverlay.png'
                alt='Active Tech Vector'
                className='w-12 absolute top-0 left-0 -translate-x-1/2 -rotate-45'
              />
      ...
      <div className='mt-16'>
        ...
        <div className='my-5 grid grid-cols-3 gap-4 relative overflow-hidden'>
        ...
        <div className='mt-10 grid grid-cols-3 gap-4 gap-y-10'>
          {whyChooseAgile.map((item, idx) => {
            return (
              <div className='p-[1.5px] bg-gradient-to-r from-primary to-secondary rounded-2xl'>
